...
<nav class="navbar navbar-expand-lg nav-light bg-light shadow fixed-top">
  <div class="container">
  <a class="navbar-brand mx-0 mx-lg-5" href="index.php">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <li class="nav-item  ">
          <a class="nav-link text-dark active" aria-current="page" href="our_hotels/our_hotels.php">OUR HOTELS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-dark" href="dining/dining.php">DINING</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  text-dark" href="wedding/wedding.php">WEDDINGS</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  text-dark" href="manage_booking/manage_booking.php">MANAGE BOOKING</a>
        </li>
        ...
        <li class="nav-item dropdown">
          ...
          <li><a class="dropdown-item  text-dark" href="signup.php">SIGN UP</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item  text-dark" href="login.php">LOG IN</a></li>
