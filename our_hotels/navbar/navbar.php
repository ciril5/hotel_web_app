...
<nav class="navbar navbar-expand-lg nav-light  bg-light shadow pt-2 pb-2 fixed-top">
  <div class="container">
  <a class="navbar-brand mx-0 mx-lg-5" href="/plala19/index.php">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <li class="nav-item  ">
          <a class="nav-link text-dark active" aria-current="page" href="our_hotels.php">OUR HOTELS</a>
        </li>
        <li class="nav-item">
