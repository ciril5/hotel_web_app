...
<nav class="navbar navbar-expand-lg nav-light fixed-top bg-light shadow pt-2 pb-2 fixed-top">
  <div class="container">
  <a class="navbar-brand mx-0 mx-lg-5" href="/plala19/index.php">
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      ...
      <li class="nav-item  ">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="/plala19/dining/dining.php">DINING</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  text-dark" href="wedding.php">WEDDINGS</a>
        </li>
                ...
                <form action="/plala19/booking-action.php" method="post">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 mt-5">                        
                            <button type="submit" class="btn  text-white comm-btn float-end">Confirm</button>
